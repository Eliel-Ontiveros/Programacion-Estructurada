...
void fibon()
{
    int repetir;
    system ("CLS");
    printf("Se realizara la sucesion de fibonacci\n");
    printf("La sucesión de Fibonacci se escribe así: n = n-1 + n-2\n");
    printf("Ingrese la cantidad de veces que quiere que se realice la Sucesion de Fibonacci\n");
    scanf("%d", &repetir);
